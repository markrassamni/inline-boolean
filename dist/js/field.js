                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt('return', Nova.request().post('/nova-api/' + this.resourceName + '/' + this.resourceId, formData).then(function () {
                                    ...
                                    _this.$toasted.show(message, { type: 'success' });
                                }, function (response) {
...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-inline-boolean', __webpack_require__(6));
    Vue.component('detail-inline-boolean', __webpack_require__(12));
    Vue.component('form-inline-boolean', __webpack_require__(15));
});
...
var render = function() {
  ...
  return _vm.field.inlineIndex
    ? _c("div", { attrs: { slot: "field" }, slot: "field" }, [
        _c("div", { staticClass: "inline-flex" }, [
          _vm.field.textOnIndex
            ? _c("div", { staticClass: "flex-1 text-center py-2 m-1" }, [
          ...
          _c(
            "div",
            { staticClass: "flex-1 text-center py-2 m-1" },
            [
              _c("checkbox", {
                attrs: {
